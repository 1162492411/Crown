...
public class SuperGenerator {
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername("lyq")
                .setPassword("123456")
                .setUrl("jdbc:mysql://127.0.0.1:3306/lyq?characterEncoding=utf8&serverTimezone=Asia/Shanghai&useSSL=false");
    }
    ...
    private String getRootPath() {
        ...
        return new File(file).getParentFile().getParentFile().getParent() + "/Crown";
    }
    ...
    protected String getJavaPath() {
        System.out.println("根目录是" + getRootPath());
